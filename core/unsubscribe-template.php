...
class Prompt_Unsubscribe_Template extends Prompt_Email_Template {

	protected $subscriber;

	public function __construct() {
		parent::__construct( 'unsubscribe-view.php', null, 'html-email-wrapper.php' );
	}
